<h2><a href="https://www.geeksforgeeks.org/problems/height-of-binary-tree/1?page=1&category=Data%20Structures,Arrays,Mathematical,Strings,Sorting,Bit%20Magic,Matrix,Greedy,Searching,Binary%20Search,Map,sieve,set&difficulty=Easy,Medium,Hard&status=unsolved&sortBy=accuracy">Height of Binary Tree</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a binary tree, find its height.</span></p>
