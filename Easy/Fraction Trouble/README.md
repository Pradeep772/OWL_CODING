<h2><a href="https://www.geeksforgeeks.org/problems/fraction-trouble1410/1?page=1&difficulty=Easy,Medium,Hard&status=unsolved&sortBy=accuracy">Fraction Trouble</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Consider the set of irreducible fractions A = {n/d | n≤d and d ≤ 10000 and gcd(n,d) = 1}.You are given a member of this set and your task is to find the largest fraction in this set less than the given fraction.<br>
