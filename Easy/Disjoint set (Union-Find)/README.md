<h2><a href="https://www.geeksforgeeks.org/problems/disjoint-set-union-find/1?page=1&category=union-find&sortBy=submissions">Disjoint set (Union-Find)</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>A[]</strong>&nbsp;that stores all number from <strong>1</strong> to <strong>N</strong> (both inclusive and sorted) and <strong>K</strong>&nbsp;queries.</span></p>
